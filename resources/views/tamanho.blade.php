...
<div class="container">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
        <form class="form" method="post" action="{{route('tamanho.store')}}" >
       
       
           <div class="col-md-6"> 
            <div class="form-group">
              <input type="text" class="form-control d-inline-flex" name="tamanho" placeholder="Tamanho" value="{{old('tamanho')}}"> 
            </div>
           </div>
