...
<div class="container">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
        <form class="form" method="post" action="{{route('espessura.update',$espess->id)}}" >
       
       
           <div class="col-md-6"> 
            <div class="form-group">
              <input type="text" class="form-control d-inline-flex" name="espessura" placeholder="Espessura" value="{{$espess->espessura or old('espessura')}}"> 
            </div>
           </div>
